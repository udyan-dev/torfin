...
@override
int get hashCode => Object.hash(runtimeType,status,emptyState,const DeepCollectionEquality().hash(torrents),const DeepCollectionEquality().hash(rawTorrentList),sortType,const DeepCollectionEquality().hash(categoriesRaw),selectedCategoryRaw,isShimmer,trendingType,const DeepCollectionEquality().hash(cacheByType),const DeepCollectionEquality().hash(favoriteKeys),notification,fetchingMagnetForKey,isBulkOperationInProgress);

@override
String toString() {
  return 'TrendingState(status: $status, emptyState: $emptyState, torrents: $torrents, rawTorrentList: $rawTorrentList, sortType: $sortType, categoriesRaw: $categoriesRaw, selectedCategoryRaw: $selectedCategoryRaw, isShimmer: $isShimmer, trendingType: $trendingType, cacheByType: $cacheByType, favoriteKeys: $favoriteKeys, notification: $notification, fetchingMagnetForKey: $fetchingMagnetForKey, isBulkOperationInProgress: $isBulkOperationInProgress)';
}
...
switch (_that) {
case _TrendingState() when $default != null:
return $default(_that.status,_that.emptyState,_that.torrents,_that.rawTorrentList,_that.sortType,_that.categoriesRaw,_that.selectedCategoryRaw,_that.isShimmer,_that.trendingType,_that.cacheByType,_that.favoriteKeys,_that.notification,_that.fetchingMagnetForKey,_that.isBulkOperationInProgress);case _:
  return orElse();
...
switch (_that) {
case _TrendingState():
return $default(_that.status,_that.emptyState,_that.torrents,_that.rawTorrentList,_that.sortType,_that.categoriesRaw,_that.selectedCategoryRaw,_that.isShimmer,_that.trendingType,_that.cacheByType,_that.favoriteKeys,_that.notification,_that.fetchingMagnetForKey,_that.isBulkOperationInProgress);}
}
