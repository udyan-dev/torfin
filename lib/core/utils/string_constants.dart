...
const String appVersionNumber = '2.2.8+23';
...
const String foregroundServiceChannelId = 'torrent_foreground_service';
const String foregroundServiceChannelName = 'Download Service';
const String foregroundNotificationTitle = 'TorFin';
const String foregroundNotificationBody = 'Downloads running in background';
const String notificationStop = 'Stop';
const String notificationTapToResume = 'Tap Resume to continue';
